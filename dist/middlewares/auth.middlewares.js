...
function registerMiddleware(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const potentialUser = yield User_1.default.findOne({ username: req.body.username });
        if (potentialUser) {
...
function SUDOMiddleware(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let isAdmin = false;
        if (user) {
            const userRoles = user.userAccess; // user.userAccess is an array of strings of mongoose object ids
            // check if any of these ids(which correspond to the type) match the admin role
            for (const roleId of userRoles) {
                const role = yield UserType_1.default.findById(roleId);
